	...
	<div class="sidebar sidebar-inverse">
		...
		<div class="sidebarMenuWrapper">
			<ul class="list-unstyled">
                ...
                <li><a href="karyawan.php?page=LIHAT ISI DATA"><i class="icon-user-1"></i><span>LIHAT ISI DATA</span></a></li> 		
			</ul>
		</div>
	</div>
</div>
...
<div class="innerAll spacing-x2">
	...
	<div class="main">
	 <div class="isimain">
	  <span class="span">Form Input Data Karyawan</span>
	   <form action="pro_tambah.php" method="POST">
		...
		Laki Laki<input type="radio" name="jenisKelamin" value="L">Perempuan<input type="radio" name="jenisKelamin" value="P"><br>
		<input type="date" name="tglLahir" placeholder="Tanggal Lahir"><br>
		<input type="text" name="jabatan" placeholder="Jabatan"><br>
		<select name="status">
		 <option>--Pilih Status--</option>
		 <option value="adm">admin</option>
		 <option value="kyr">Karyawan</option>
