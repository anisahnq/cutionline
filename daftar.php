...
<body class="">
    ...
    <div class="navbar-header pull-left">
        <div class="navbar-brand">
            ...
            <a href="index.php" class="appbrand innerL">AMBIL CUTI ONLINE</a>
        </div>
    </div>
</div>
	...
	<div class="sidebar sidebar-inverse">
		<div class="user-profile media innerAll">
			...
			<div class="media-body">
				...
				<p class="text-success"><i class="fa fa-fw fa-circle"></i> Ofline</p>
			</div>
		</div>
...
<div class="innerAll spacing-x2">
	<div class="row">
		...
		<tr>
		<td>id_user</td><td>:</td><td><input type="text" name="id_user"></td>
		</tr>
		<tr>
